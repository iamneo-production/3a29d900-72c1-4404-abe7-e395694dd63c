...
//  HttpResponseMessage response = await _httpClient.GetAsync("admin/Profile");
...
//  HttpResponseMessage response = await _httpClient.GetAsync("admin/getAlljobs");
...
//  HttpResponseMessage response = await _httpClient.GetAsync("user/dashboard");
...
//  HttpResponseMessage response = await _httpClient.GetAsync("jobseeker/getJobs");
...
//  HttpResponseMessage response = await _httpClient.GetAsync("jobseeker/getAppliedJobs");
